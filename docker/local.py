...
if not DATABASE_URL:
    ...
    if POSTGRES_IP:
        ...
        POSTGRES_DB = os.environ.get('POSTGRES_DB', 'wagtail_map')
        ...
        DATABASE_URL = 'sqlite://wagtail_map.db'
...
if ELASTICSEARCH_URL:
    ELASTICSEARCH_INDEX = os.environ.get('ELASTICSEARCH_INDEX', 'wagtail_map')
...
if REDIS_LOCATION:
    ...
    REDIS_KEY_PREFIX = os.environ.get('REDIS_KEY_PREFIX', 'wagtail_map')
